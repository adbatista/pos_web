class BooksController < ApplicationController
  # chama o metodo set_book antes das actions show, edit, update e destroy
  ...
  def create
    ...
    @book = book_builder.build(book_params)
  ...
  private
    ...
    def book_params
      params.require(:book).permit(:name, :type, :user_id)
    end
end
