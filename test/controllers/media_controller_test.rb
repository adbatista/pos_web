...
class MediaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medium" do
    assert_difference('Medium.count') do
      post media_url, params: { medium: { name: @medium.name, type: @medium.type, user_id: @medium.user_id } }
    end
  ...
  test "should update medium" do
    patch medium_url(@medium), params: { medium: { name: @medium.name, type: @medium.type, user_id: @medium.user_id } }
